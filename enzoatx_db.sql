...
select customerBookings.Customer_ID, customer.Customer_FirstName, customer.Customer_LastName, customerBookings.PurchaseDate
...
select ongoingSubscriptions.Customer_ID, ongoingsubscriptions.Subscription_ID, Subscription_Tokens
...
select customer.Customer_ID, Customer_FirstName, Customer_LastName
from customer
